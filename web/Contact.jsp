		...
		<div class="wrap-contact100">
				...
				<span class="contact100-form-title">
					Send Us A Message
                        ...
                        <center><h2><p class="txt3"  id="msg" ></p><a href='Index.jsp' id="lien"  style="display: none">Reteur</a></h2></center>   
				...
				<div class="wrap-input100">
					<input id="phone" class="input100" type="text" name="phone" placeholder=" +212.000.000">
					<span class="focus-input100"></span>
				</div>
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('images/Nous-contacter.png');">
